...
class XmlMetadataImportIntegrationTest extends IntegrationTestCase {
    ...
    public function testFlagExampleImport() {
        ...
        $this->assertContains(['Artyści obcy w służbie polskiej'], $importedValues);
        $this->assertContains(['Artyści obcy w służbie polskiej - epizody z dziejów sztuki'], $importedValues);
        $this->assertContains(['pol'], $importedValues);
    }
}
