describe('Login Tests', function() {
  ...
  it('Log out', function() {
	  ...
	  var logOutButton = element(by.cssContainingText('a', 'Wyloguj'));
	  logOutButton.click();
  ...
  it('Wrong user login', function() {
	  ...
	  var errorInfo = element(by.className('login-error-notification alert'));
	  expect(errorInfo.getText()).toContain('Dane logowania są nieprawidłowe.');
  });
